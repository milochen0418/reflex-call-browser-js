    ...
    return rx.fragment(
        rx.center(
            rx.vstack(
                ...
                rx.button("call test_func_1", on_click=State.btn_test_func_1),
                rx.button("call test_func_2", on_click=State.btn_test_func_2),
                rx.button("call test_func_3", on_click=State.btn_test_func_3),
            ),
        ),
    )
